package _05.aspectj.annotation.service;
...
public class AuditServiceAspect {
	...
	@Before("execution(* _05.aspectj.annotation.service.EmployeeService.saveEmployee(..))")
	public void logBefore() {
		System.out.println("logBefore is invoked...");
	}
	
	@After("execution(* _05.aspectj.annotation.service.EmployeeService.updateEmployee(..))")
	public void logAfter() {
		System.out.println("logAfter is invoked...");
	}
	
	@AfterReturning(pointcut = "execution(* _05.aspectj.annotation.service.EmployeeService.getEmployeeId(..))", returning = "resultValue")
	...
	@AfterThrowing(pointcut="execution(* _05.aspectj.annotation.service.EmployeeService.deleteEmployee(..))" ,throwing="thrownException")
	...
	@Around("execution(* _05.aspectj.annotation.service.EmployeeService.getAllEmployees(..))")
