...
public class PersonDAONamedJDBCTemplateImpl implements PersonDAONamedJDBCTemplate {
	//sorguda parametreyi soruiþareti kullanmadan veriyoruz.
	...
	//_03.spring.namedjdbctemplate.xml dosyasýnda constructor arg kullanýldýgý için constructor injection yapýlýr.
	public PersonDAONamedJDBCTemplateImpl(NamedParameterJdbcTemplate namedParameterJdbcTemplate) {
		super();
		this.namedParameterJdbcTemplate = namedParameterJdbcTemplate;
	}
	
	//_03.spring.namedjdbctemplate.xml dosyasýnda <property> kullanýlsaydý setter injection yapýlýrdý.
	...
	public void insertPerson(Person person) throws Exception {
		//burada parametreleri verdik. aþaðýda sorguyu çalýþtýrdýk.
