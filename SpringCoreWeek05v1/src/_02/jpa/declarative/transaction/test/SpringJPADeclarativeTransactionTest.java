package _02.jpa.declarative.transaction.test;

import org.springframework.context.support.ClassPathXmlApplicationContext;

import _02.jpa.declarative.transaction.model.Address;
import _02.jpa.declarative.transaction.model.Customer;
import _02.jpa.declarative.transaction.service.CustomerService;

public class SpringJPADeclarativeTransactionTest {

	public static void main(String[] args) {

		ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext("_02.jpa.declarative.transaction.xml");
